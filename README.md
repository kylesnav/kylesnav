...
| surface | repo |
|---|---|
| tokens + docs | [`delightful-design-system`](https://github.com/kylesnav/delightful-design-system) |
...
| starship + zsh | [`delightful-shell`](https://github.com/kylesnav/delightful-shell) |
